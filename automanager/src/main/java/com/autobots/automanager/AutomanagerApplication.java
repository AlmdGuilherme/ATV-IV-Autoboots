...
public class AutomanagerApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        admin.getNivelAcesso().add(UserRoles.ROLE_ADMIN);

        Email emailAdmin = new Email();
        emailAdmin.setEndereco("admin@loja.com");
        ...
        gerente.getPerfis().add(PerfilUsuario.FUNCIONARIO);
        gerente.getNivelAcesso().add(UserRoles.ROLE_GERENTE);

        Email emailGerente = new Email();
        emailGerente.setEndereco("gerente@loja.com");
        ...
        credencialGerente.setSenha("123456");
        ...
        funcionario.getNivelAcesso().add(UserRoles.ROLE_VENDEDOR);
        ...
        cliente.getNivelAcesso().add(UserRoles.ROLE_CLIENTE);
